  ...
  return (
    <section id="hero" className="relative overflow-hidden pt-5 md:pt-7">
      ...
      <div className="mx-auto flex min-h-[calc(100svh-3.5rem)] w-full max-w-[102rem] items-center px-5 pb-16 md:min-h-[calc(100svh-4.5rem)] md:px-8 md:pb-20 lg:px-10">
        <div className="grid w-full items-start gap-10 md:gap-12 lg:grid-cols-[1.3fr,0.8fr] lg:gap-14">
          ...
          <Reveal delay={0.08} className="lg:pl-2">
            <div className="card-surface mx-auto flex w-full max-w-[40rem] flex-col space-y-7 rounded-3xl p-5 sm:p-6 md:p-8">
              <div className="relative overflow-hidden rounded-2xl bg-white p-4 sm:p-5">
                <Image
              ...
              <div>
                ...
                <p className="mt-2 max-w-[28rem] text-base leading-relaxed text-muted">
