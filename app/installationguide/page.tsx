  ...
  return (
    ...
    >
      <section className="space-y-3">
        <h2 className="text-[22px] font-bold">1. System requirements</h2>
        <p className="text-[18px]">twindow supports macOS Ventura (13.0) or newer on Apple Silicon Macs (M1, M2, M3, and M4).</p>
      </section>

      <section className="space-y-3">
        <h2 className="text-[22px] font-bold">2. Download and install</h2>
        <ol className="list-decimal space-y-2 pl-5 text-[18px]">
      ...
      <section className="space-y-3">
        <h2 className="text-[22px] font-bold">3. First launch</h2>
        <ol className="list-decimal space-y-2 pl-5 text-[18px]">
      ...
      <section className="space-y-3">
        <h2 className="text-[22px] font-bold">4. Required permissions</h2>
      ...
      <section className="space-y-5">
        <h2 className="text-[22px] font-bold">5. Permission walkthrough</h2>
        ...
        <div className="space-y-3">
          ...
          <p className="text-[18px]">
            ...
            the toggle next to <strong>twindow</strong>. indow to record your screen and audio. Remember, twindow is using this permission to duplicate the selected window to a twindow on another display. Nothing is recorded, stored, or saved to a video file.
          </p>
          <Image
        ...
        <div className="space-y-3">
          ...
          <h2 className="text-[26px] font-bold">You should now be able to launch the twindow application</h2>
        </div>
      </section>

      <section className="space-y-3">
        <h2 className="text-[26px] font-bold">6. Troubleshooting</h2>
        <ul className="list-disc space-y-2 pl-5 text-[18px]">
      ...
      <section className="space-y-3">
        <h2 className="text-[22px] font-bold">7. Need help?</h2>
        <p className="text-[18px]">
